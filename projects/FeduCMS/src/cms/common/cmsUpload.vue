...
<script>
  // require('../assets/aliyunUpload/aliyun-oss-sdk-5.3.1.min.js')
  // require('../assets/aliyunUpload/aliyun-oss-sdk-6.10.0.min')
  // require('../assets/aliyunUpload/aliyun-upload-sdk-1.5.0.min.js')
  ...
  export default {
    ...
    data() {
      return {
        ...
        show: false,
        fileTitle: '13',
        fileAction: `${process.env.VUE_APP_FILE}/file/file/upload`,
        wareFileAction: `${process.env.VUE_APP_FILE}/file/file/uploadware`,
        schedule: '0%', // 上传进度
        uploadText: '正在上传',
        ...
        return new Promise((resolve) => {
          ...
          input.onchange = async (e) => {
            ...
            if (type === 'ali') {
              ...
              const result = await that.uploadFile(file)
              this.uploadText = '上传完成'
              that.schedule = '100%'
              setTimeout(() => {
                result.file = file

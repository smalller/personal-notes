    ...
    <div class="phone">
      <div class="phone-show">
        ...
        <div class="phone-content">
          ...
          <div v-if="+phoneNews.dynamicType === 1" class="pic-content">
    ...
    methods: {
      ...
      setContent() {
        if (this.news.content !== undefined) {
          ...
          if (+this.phoneNews.dynamicType === 1) {
            this.pictureList = []
            this.showVideoPath = ''
            for (let item of this.phoneNews.picturePath) {
              this.getFile(item, 'picture')
            }
          }
          if (+this.phoneNews.dynamicType === 2) {
            this.getFile(this.phoneNews.videoPath)
          }
          this.getCommentList()
        }
      },

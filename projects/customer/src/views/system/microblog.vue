    ...
    <div class="city_local">
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="userName" label="发布者(昵称)" min-width="150" align="center"></el-table-column>
                <el-table-column prop="labelName" label="动态话题" min-width="150" align="center">
                    <template slot-scope="scope">
                        <div class="com_del_box">{{ scope.row.labelName || '-' }}</div>
                    </template>
                </el-table-column>
                <!-- <el-table-column prop="title" label="标题" min-width="250" align="center"></el-table-column> -->
                <el-table-column label="动态文本" min-width="150" align="center">
                    <template slot-scope="scope">
            ...
            <div class="figure">
                <el-form ref="form" :model="form" label-width="120px" class label-position="left ">
                    <div class="detail_box">
                        ...
                        <el-form-item label="话题：" v-if="form.topicName">
                            <div class="lab_text">{{ form.labelName }}</div>
                        </el-form-item>
                        <!-- <el-form-item label="@谁：">
                            <div class="lab_text">
                                <span style="margin-right: 12px" v-for="(item, index) in form.atDTOList" :key="index">{{
                                    item.targetName
                                }}</span>
                            </div>
                        </el-form-item> -->
                        <el-form-item label="发布时间：" v-if="form.createTime">
                            <div class="lab_text">{{ form.createTime }}</div>
                        </el-form-item>
                        <el-form-item label="发帖地址：" v-if="form.position">
                            <div class="lab_text">{{ form.position }}</div>
                        </el-form-item>
                        <el-form-item label="私密性：">
                            <div>{{ form.scope == 1 ? '公开' : (form.scope == 2? '好友' : '私密') }}</div>
                        </el-form-item>
                                ...
                                <div v-for="(item, index) in coms_list" :key="index" class="com_li">
                                    <div class="com_top">
                                        <div class="user">
                                            ...
                                            <span class="com_time">{{ item.updateTime }}</span>
                                        </div>
                                        <div class="like">
...
<script>
import {getList, getDetail, add, update, remove,allComment,delComment} from "@/api/system/microblog";

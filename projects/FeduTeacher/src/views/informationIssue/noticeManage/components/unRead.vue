  ...
  <div class="manage-student">
    ...
    <div v-loading="loading">
      <ui-table :data="studentList" width="100%" class="table-box">
        ...
        <ui-table-column prop="clazzName" label="班级" align="left" width="100">
        </ui-table-column>
        <ui-table-column
          prop="mobile"
          label="家长电话"
    ...
    <!--    <Nodata v-if="studentList.length === 0 && !loading" :type="2"></Nodata>-->
...
// import Nodata from "@/views/staffManage/classManage/components/noData.vue";
import bus from "@/Layout/bus";
import { getUnReadList } from "@/api/reviewManage";
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const getStudentLists = async (): Promise<any> => {
      ...
      let url = `/notice/api/receiver/queryUnRead/${props.id}`;
      loading.value = true;
